...
include ("functions/baglanti.php");
		if(isset($_POST["hgonder"])){
			$baslik =mysql_real_escape_string($_POST["hbaslik"]);
			$icerik =mysql_real_escape_string($_POST["hicerik"]);
			$level =sGet('name');
			$tarih =date("d-m-Y");
...
<?php
			...
			if(isset($_POST["hguncelle"])){
				$hguncelbaslik=mysql_real_escape_string($_POST["hguncelbaslik"]);
				$hguncelicerik=mysql_real_escape_string($_POST["hguncelicerik"]);
